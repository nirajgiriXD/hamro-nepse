        ...
        <div className="mt-4" ref={dropdownRef}>
          ...
          <div className="relative inline-block w-44">
            <button
              ...
              onClick={() => handleTransactionTypeChange(transactionType === 'buy' ? '' : 'buy')}
              onMouseEnter={toggleDropdown}
              onBlur={toggleDropdown}
              className={`text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center ${
                transactionType === 'buy' ? 'dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' : ''
              }`}
              type="button"
            >
              {transactionType === 'buy' ? 'Select Buy or Sell' : 'Select Buy or Sell'}
              <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
              </svg>
            </button>
            {isDropdownOpen && (
              <div id="dropdown1" className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton1">
                  <li>
                    <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleTransactionTypeChange('buy')}>
                      Buy
                    </a>
                  </li>
                  <li>
                    <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleTransactionTypeChange('sell')}>
                      Sell
                    </a>
                  </li>
                </ul>
