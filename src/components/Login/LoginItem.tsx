                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm font-medium text-primary-600 hover:underline dark:text-white dark:text-opacity-75">Forgot password?</a>
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Dont have an account yet? <a href="#" className="font-medium text-sky-600 hover:underline dark:text-white">Sign up</a>
                            </p>
                        </form>
                    </div>
                </div>
